...
class ReceiverService : Service() {
    ...
    override fun onCreate() {
        ...
        startForeground(1, Notification.Builder(this, "receiver").setContentTitle("WiFi Remote Input").setContentText("局域网接收已开启；可在应用内停止").setSmallIcon(android.R.drawable.ic_dialog_info).setContentIntent(open).build())
